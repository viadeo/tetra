...
module.exports = (function() {
    ...
    //
    var Guru = function(configuration, skipFiles) {
        if (!configuration) {
        ...
        if ( ! skipFiles) {
            ...
            files.forEach(function(file) {
                if (fs.statSync(path + file).isFile()) {
                    var resource = Guru.parseResource(path, file);
                    if ( ! resource.locale ) {
                        resource.locale = file.replace(that.configuration.resources.serialisation, '');
                    }
    ...
    // default resource parser (JSON)
    Guru.parseResource = function(path, file) {
